...
class IsotonicRegression(RegressorMixin, TransformerMixin, BaseEstimator):
    ...
    def __init__(self, *, y_min=None, y_max=None, increasing=True, out_of_bounds="nan", test=None):
        self.y_min = y_min
        self.y_max = y_max
    ...
    def _build_y(self, X, y, sample_weight, trim_duplicates=True):
        ...
        X = unique_X
        if self.test:
            from .cir import cirPAVA
            y = cirPAVA(unique_y, x=unique_X, wt=unique_sample_weight, ybounds=np.asarray([self.y_min, self.y_max]), dec=not self.increasing_)
        else:
